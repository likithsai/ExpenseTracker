                ...
                renderItem={({ item }) => (
                    <TouchableOpacity style={{ padding: 20, elevation: 5, backgroundColor: '#fff', flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }} onPress={() => {
                        ...
                        <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                            <FeatherIcons name={item.category_icon || 'alert-triangle'} size={30} color="#fff" style={{ marginRight: 15, backgroundColor: '#11998e', padding:12, borderRadius: 10, marginTop: 5, elevation: 10 }} />
                            <View>
